...
def clickNext() :
    ...
    if num > 8 :
        num = 0
    photo = PhotoImage(file=r"C:\Users\jooro\OneDrive\바탕 화면\PythonProgramming_\Week9\\" +fnameList[num])
...
photo = PhotoImage(file=r"C:\Users\jooro\OneDrive\바탕 화면\PythonProgramming_\Week9\\" +fnameList[0])
